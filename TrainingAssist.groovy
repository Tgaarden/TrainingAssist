/**
 *
 *  Training Assist - Advanced Training Assist
 *
 *  Author: Thomas B Gaarden
 *
 * 2/15/21 - First version of smartApp
 *
 **/
 ...
 *********************************************************************/
definition(
        name: "Training Assist",
        namespace: "tgaarden",
        author: "Thomas B Gaarden",
        description: "Advanced Training Assist",
        category: "My Apps",
...
preferences {
    page(name: "pageMain", title: "Training Mappings", install: true, uninstall: true)
    page(name: "pageAbout", title: "About Training Assist")
}
...
def pageMain() {
    dynamicPage(name: "pageMain") {
        ...
        section("Create a new button device mapping.") {
            app(name: "childApps", appName: "ABC Child Creator", namespace: "tgaarden", title: "Create New Button Device Mapping", multiple: true)
        }
